...
scatterplotMatrix(sat.df)   ### NOT shown in book
...
# predicting one response from the coefficients
-94.962 + 1.703*95
...
library(coefplot)      # intall "coefplot" package as needed
...
# number of children as factor rather than number
...
# coding for "has child" as opposed to nominal factor
