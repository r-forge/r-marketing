###################################
# Code for: R for Marketing Research and Analytics, 2nd ed: Chapter 9
#
...
#################################################################
# BRIEF HOW TO USE
# This file contains scripts used in Chapter 9 of Chapman & Feit (2019),
...
### NOTE: install package "forecast" first, if needed
...
summary(cust.df.bc)              # output not shown in book
scatterplotMatrix(cust.df.bc)    # output not shown in book
...
# simulation that generates the data 
# construct the data 
...
ride.hlm2 <- lmer(rating ~ speed + height + const + theme + 
                 ...
                 control=lmerControl(optCtrl=list(maxfun=100000),
                                     optimizer ="Nelder_Mead"))  # default = 10000
...
### BEGIN: this section NOT IN BOOK
### LME also has a distribution; e.g., standard errors
library(arm)
