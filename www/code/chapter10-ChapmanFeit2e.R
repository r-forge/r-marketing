###################################
# Code for: R for Marketing Research and Analytics, 2nd ed: Chapter 10
#
...
#################################################################
# BRIEF HOW TO USE
# This file contains scripts used in Chapter 10 of Chapman & Feit (2019),
...
# note: scatterplotMatrix can be very slow, draws elements one at a time
...
# note: can produce warnings depending on lavaan version
...
# ERROR: semTools 0.5-1 produces an error; this is new, and hope will be
#        resolved soon
summary(compareFit(pies.fit.NH1, pies.fit.NH3, pies.fit))    # error in 0.5-1
...
# basic psychometrics
library(psych)
psych::alpha(satSimData)         # gives warning, which is OK
...
################
# plot it --- ONLY FOR PRINT, not SHOWN AS CODE in book
# shown here as an example of how to get the structure without the details
# structural version
...
##############
### just the structural models -- for PDF in book PRINT ONLY, NOT shown as CODE
# structural version
...
# will produce an ERROR unless you have graphizviz set up and callable 
# from the system
